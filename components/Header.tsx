        ...
        >
            <nav className="flex items-center justify-between w-full px-6 py-4 bg-dark/80 backdrop-blur-md border-b border-white/5 shadow-2xl shadow-dark/50">
                ...
                <div className="flex items-center gap-2">
                    {/* AÑADIDO: font-heading */}
                    <span className="font-heading text-lg font-bold text-beige tracking-tighter hover:text-lime transition-colors duration-300">
                    ...
                    {navItems.map((item) => (
                        <li key={item.name}>
                            <a
                                href={item.href}
                                // AÑADIDO: font-heading
                                className="font-heading flex items-center gap-2 px-3 py-2 text-sm font-medium text-beige/80 hover:text-lime transition-all duration-300 group"
                            >
